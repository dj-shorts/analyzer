...
class TestPrometheusMetricsEpicG1:
    ...
    def test_stage_duration_calculation(self):
        ...
        # Check durations
        audio_duration = self.collector.metrics.get_stage_duration(AnalysisStage.AUDIO_EXTRACTION)
        novelty_duration = self.collector.metrics.get_stage_duration(AnalysisStage.NOVELTY_DETECTION)
    ...
    def test_edge_cases(self):
        ...
        self.collector.start_stage(AnalysisStage.NOVELTY_DETECTION)
        duration = self.collector.metrics.get_stage_duration(AnalysisStage.NOVELTY_DETECTION)
