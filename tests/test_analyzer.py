...
class TestSegmentBuilder:
    ...
    def test_calculate_segment_length(self):
        ...
        assert length_low < (self.config.min_clip_length + self.config.max_clip_length) / 2
        ...
        # Test edge cases
        assert self.builder._calculate_segment_length(0.0) == self.config.min_clip_length
        assert self.builder._calculate_segment_length(1.0) == self.config.max_clip_length
...
class TestAnalyzerIntegration:
    ...
    def test_analyzer_pipeline(self, mock_export, mock_segments, mock_peaks, mock_novelty, mock_audio):
        ...
        mock_segments.return_value = {
            "segments": [
                {"clip_id": 1, "start": 5.0, "end": 20.0, "center": 10.0, "score": 0.8, "seed_based": False, "aligned": False, "length": 15.0}
            ]
        }
