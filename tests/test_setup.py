...
from scripts.setup import DependencyInstaller
...
class TestDependencyInstaller:
    ...
    def test_install_dependency_already_installed(
        self, mock_pip, mock_pkg_mgr, mock_installed
    ):
    ...
    @patch.object(DependencyInstaller, "_install_with_package_manager")
    @patch.object(DependencyInstaller, "_install_with_pip")
    def test_install_dependency_fallback_pip(
        self, mock_pip, mock_pkg_mgr, mock_installed
    ):
