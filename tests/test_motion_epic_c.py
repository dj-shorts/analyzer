...
class TestMotionDetectorEpicC:
    ...
    def test_interpolate_to_audio_timeline(self):
        ...
        interpolated_unavailable = detector.interpolate_to_audio_timeline(
            motion_data_unavailable, audio_times
        )
    ...
    def test_combine_audio_and_motion_scores(self):
        ...
        combined_mismatch = detector.combine_audio_and_motion_scores(
            audio_long, motion_scores
        )
