...
class ResourceManager:
    ...
    def __init__(self, max_threads: int | None = None, ram_limit: str | None = None):
        """
        ...
        self._cancellation_manager: CancellationManager | None = None

    def set_cancellation_manager(
    ...
    def _parse_ram_limit(self, ram_limit: str | None) -> int | None:
        """
...
@contextmanager
def managed_resources(max_threads: int | None = None, ram_limit: str | None = None):
    """
    ...
    try:
        ...
        logger.info(
            f"Resource management initialized (threads: {max_threads}, RAM: {ram_limit})"
        )
...
class ProcessMonitor:
    ...
    def run_subprocess(self, cmd: list[str], **kwargs) -> subprocess.Popen:
        ...
        if (
            hasattr(self.resource_manager, "_cancellation_manager")
            and self.resource_manager._cancellation_manager is not None
        ):
    ...
    def wait_for_completion(
        ...
        try:
            ...
            logger.warning("Subprocess timed out, terminating...")
            process.kill()
            self.resource_manager.unregister_process(process)
            raise
        except Exception as e:
