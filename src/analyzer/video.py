...
class VideoExporter:
    ...
    def _build_auto_reframe_filter(self, input_width: int, input_height: int, target_width: int, target_height: int,
                                  input_path: Path, start_time: float, duration: float) -> str:
        """
        Build FFmpeg filter for auto-reframe with people detection.
        ...
        try:
            ...
            if detection_result["success"] and detection_result["center_x"] is not None:
                ...
                crop_x, crop_y, crop_width, crop_height = self.people_detector.calculate_crop_window(
                    center_x, input_width, input_height, target_width, target_height
                )
                ...
                return self._build_crop_scale_filter(input_width, input_height, target_width, target_height)
